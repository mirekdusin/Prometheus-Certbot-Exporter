...
async def metrics() -> str:
    ...
    """
    certbot_metrics.collect_metrics()
    return generate_latest()


if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Run the Prometheus-Certbot-Exporter')
    ...
    certbot_metrics = MetricsCollector(config_dir)
